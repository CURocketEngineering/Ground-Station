...
class GraphDataManager:
    ...
    def get_accel_plot_data(self) -> Tuple[List[float], List[float], List[float], List[float]]:
        """Accelerometer data formatted for plotting"""
        return list(self.acl_timestamps), list(self.accel_x), list(self.accel_y), list(self.accel_z)
...
class StatusModel:
    ...
    def get_accel_graph_data(self) -> Tuple[List[float], List[float], List[float], List[float]]:
