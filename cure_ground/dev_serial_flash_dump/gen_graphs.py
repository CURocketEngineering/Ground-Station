...
def main(path_to_csv, first_id, ten_sec_launch):
    ...
    apogee_time = (
        apogee_time / 1000 - launch_time / 1000
    )  # Make apogee time relative to launch time
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--first_id",
        action="store_true",
        help="If should stop once the timestamp goes backwards or flight id changes",
    )
    parser.add_argument(
        "--ten_sec_launch",
        action="store_true",
        help="Only graph data +- 10 seconds from launch",
        default=False,
    )
